...
try:
	...
	<body>
	    ...
	    <p>Nastal nějaký problém, pokuste se ke hře připojit znovu. Mějte na paměti, že jméno smí obsahovat pouze čísla, písmenka české abecedy, mezeru a podtržítko.</p>	
	</body>
    </html>
    """.format(gameid)
    print(page)
